...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hillosdorados" },
      { name: "description", content: "Fios de nylon termodegradáveis para indústria têxtil consciente." },
      { name: "author", content: "Hillosdorados" },
      { property: "og:title", content: "Hillosdorados" },
      { property: "og:description", content: "Fios de nylon termodegradáveis para indústria têxtil consciente." },
